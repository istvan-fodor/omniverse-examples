...
if not parent.IsValid():
    parent = UsdGeom.Scope.Define(stage, default_prim.GetPath().AppendChild("Rocks"))

# Create materials for the texture files
materials = [
...
if save:
    ...
    print("Rocks with tessellation and bump mapping generated and saved as rocks_with_advanced_materials.usda")
